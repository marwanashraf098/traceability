...
**575 backend tests green** — 2026-07-11 (V43 + FR-12.6 CRP return shipment leg). Pushed to origin/main (commit `2b42e25`). Deploy to Hetzner pending SSH key (operator must run: `git pull && docker compose build --no-cache && docker compose up -d`).
