...
class Day7Test {
    ...
    void setup() {
        ...
        ResponseEntity<TokenResponse> ra = rest.postForEntity(
                ...
                new SignupRequest("TenantA", "owner_a", "ownera@day7.test", "01012345678", "password99", true),
                TokenResponse.class);
        ...
        ResponseEntity<TokenResponse> rb = rest.postForEntity(
                base() + "/api/v1/auth/signup",
                new SignupRequest("TenantB", "owner_b", "ownerb@day7.test", "01012345678", "password99", true),
                TokenResponse.class);
