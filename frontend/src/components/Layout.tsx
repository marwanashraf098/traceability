...
function IconLocations()   { return <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/><circle cx="12" cy="9" r="2.5"/></svg> }
function IconShopifyInv()  { return <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.75" viewBox="0 0 24 24"><path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10"/><path d="M17 15l2 2 4-4" strokeLinecap="round" strokeLinejoin="round"/></svg> }
    ...
    <div className="flex h-screen bg-base overflow-hidden">
      ...
      <aside className="w-56 flex-shrink-0 bg-panel border-e border-line flex flex-col">
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-3 space-y-0.5">
          ...
          {role !== 'worker' && (
            <>
              <SideNavLink to="/locations"        icon={<IconLocations />}   label={t('nav.locations')} />
              <SideNavLink to="/shopify-inventory" icon={<IconShopifyInv />} label={t('nav.shopifyInventory')} />
